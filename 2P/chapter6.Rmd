...
cat("The variance of the number of diners in the restaurant at 2pm is", var(diners_2pm))
...
cat("The mean of the number of points in the ball centered at the origin is", mean(sim), "\n")
cat("The variance of the number of points in the ball centered at the origin is", var(sim), "\n")
...
cat("The mean of total present value of the bonds purchased is", mean(sim), "\n")
...
cat("The mean of the number of persons that have to be asked before three persons are found to have the same birthday is", mean(sim), "\n")
