...
gamble <- function(k, n, p, goal) {
  ...
  cat("\n\nTimes played: ", times_played, "\tMaximum acumulated stake: ", max_stake)
...
cat("\n\n\nThe probability of reaching the goal of $", goal, "before lossing everything is", prob_reach_goal, ", with p =", p)
```
